 ...
 */
final class Version20211202085312 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fight_men (id INT AUTO_INCREMENT NOT NULL, winner_id INT NOT NULL, UNIQUE INDEX UNIQ_C1D17A795DFCD4B8 (winner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fighter_men (id INT AUTO_INCREMENT NOT NULL, division_id INT NOT NULL, origin_id INT NOT NULL, fight_men_id INT NOT NULL, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, height DOUBLE PRECISION NOT NULL, weight DOUBLE PRECISION NOT NULL, INDEX IDX_67F5D80A41859289 (division_id), INDEX IDX_67F5D80A56A273CC (origin_id), INDEX IDX_67F5D80A1965E510 (fight_men_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
