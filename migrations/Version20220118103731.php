 ...
 */
final class Version20220118103731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fight_men (id INT AUTO_INCREMENT NOT NULL, red_fighter_men_id INT NOT NULL, blue_fighter_men_id INT NOT NULL, winner_id INT DEFAULT NULL, date DATE NOT NULL, INDEX IDX_C1D17A7925D61D69 (red_fighter_men_id), INDEX IDX_C1D17A7994AC1FB (blue_fighter_men_id), INDEX IDX_C1D17A795DFCD4B8 (winner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
